#ifndef SCENE_TRIANGULATION_3_COLOR_ITEM_H
#define SCENE_TRIANGULATION_3_COLOR_ITEM_H

#include "Scene_triangulation_3_color_item_config.h"
#include "C3t3_info_type.h"
...
using namespace CGAL::Three;
  class SCENE_TRIANGULATION_3_COLOR_ITEM_EXPORT Scene_triangulation_3_color_item
...
public:
  ...
  Scene_triangulation_3_color_item(bool display_elements = true);
  Scene_triangulation_3_color_item(const TrInfo t3, bool display_elements = true);
  ~Scene_triangulation_3_color_item();
  ...
  virtual const TrInfo& triangulation() const;
  virtual TrInfo& triangulation();
  ...
  Scene_triangulation_3_color_item* clone() const  override;
  ...
  protected:
    friend struct Scene_triangulation_3_color_item_priv;
    mutable Scene_triangulation_3_color_item_priv* d;
    ...
    virtual bool do_take_cell(const TrInfo::Cell_handle&) const { return true; }
    virtual bool do_take_facet(const TrInfo::Facet&)const { return true; }
    virtual bool do_take_vertex(const TrInfo::Vertex_handle&)const { return true; }
    virtual bool is_facet_oriented(const TrInfo::Facet&)const { return true; }
    virtual bool is_surface() const { return false; }
};

#endif // SCENE_TRIANGULATION_3_COLOR_ITEM_H
